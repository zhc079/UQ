...
There some possible physical reasons for such reduction in uncertainty. At low electric fields, the charge carriers spend a significant amount of time in some low-energy sites which are generated in the Monte Carlo sampling. 
As the field strength increases, the drift term becomes more dominant, reducing the impact of these stochastic factors. 

Furthermore, a stronger electric field help the carrier to escape from the low energy sites more efficiently. This effect would reduce variability in observed mobilities, contributing to a narrowing confidence interval.
