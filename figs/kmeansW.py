...
egval1 = np.sort(np.loadtxt("PBE0/eigenvalLw.txt"))[0:7]
egval2 = np.sort(np.loadtxt("PBE/eigenvalLw.txt"))[0:7]
egval3 = np.sort(np.loadtxt("B3LYP/eigenvalLw.txt"))[0:7]
egval4 = np.sort(np.loadtxt("BHANDHLYP/eigenvalLw.txt"))[0:7]
egval5 = np.sort(np.loadtxt("TPSS/eigenvalLw.txt"))[0:7]
egval6 = np.sort(np.loadtxt("BP86/eigenvalLw.txt"))[0:7]
egval7 = np.sort(np.loadtxt("wB97X/eigenvalLw.txt"))[0:7]
egval8 = np.sort(np.loadtxt("wB97X-D3/eigenvalLw.txt"))[0:7]
egval9 = np.sort(np.loadtxt("M06L/eigenvalLw.txt"))[0:7]
egval10 = np.sort(np.loadtxt("BHLYP/eigenvalLw.txt"))[0:7]
...
plt.tick_params(
    ...
    labelbottom=False) 
fig.savefig("fig_distri_eigenVecLW.pdf",dpi=300)
...
plt.tight_layout()
fig.savefig("fig_Z_ToF_LW.pdf",dpi=400)