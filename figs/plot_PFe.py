...
mu_PBE0 = np.loadtxt("PBE0/mu_e.txt")
mu_PBE = np.loadtxt("PBE/mu_e.txt")
mu_B3LYP = np.loadtxt("B3LYP/mu_e.txt")
mu_BHANDHLYP = np.loadtxt("BHANDHLYP/mu_e.txt")
mu_TPSS = np.loadtxt("TPSS/mu_e.txt")
mu_BP86 = np.loadtxt("BP86/mu_e.txt")
...
ax.set_ylabel("$\mu_e \; [cm^2/(Vs)]$",size=14)
...
plt.savefig('PFe_plot.pdf', dpi=500)
