...
Es_PBE0 = np.loadtxt("PBE0/Estat_PBE0.txt")
...
for fi in range(3):
    for fj in range(3):
        ...
        str1 = dict_funt[2+fi*3+fj]
        ax00.set_xlabel(r"$E_s$(PBE0) [eV]",fontsize=12)
        ax00.set_ylabel(r"$E_s$("+str1+") [eV]",fontsize=12)
        ...
        scatter_hist(dict_Es[1], dict_Es[2+fi*3+fj], ax00, ax00_histx, ax00_histy)

plt.tight_layout()
plt.savefig("scatterEs_all.pdf",dpi=500)